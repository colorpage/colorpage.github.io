// #come from##
// file:///zytmp/gitsrc/sqlalchemyorg/zzzeeksphinx/zzzeeksphinx/themes/zzzeeksphinx/static/init.js 
// file:///zytmp/gitsrc/bscc/bsccWiki/.doc.sqlalchemy.output/dirhtml/zzstatic/init.js
//
function initSQLPopups() {
    //$('div.bscc_explain_frame').hide();
    $('div.bscc_explain_frame').show();
    $('a.bscc_link').click(function() {
        $(this).nextAll('div.bscc_explain_frame:first').toggle();
        return false;
    });
}
